...
Don't forget to update the event.json detail with the fields you want to set from your schema.edu_orders.orderconfirmed.OrderConfirmed object
...
```bash
email-service$ cd HelloWorldFunction
